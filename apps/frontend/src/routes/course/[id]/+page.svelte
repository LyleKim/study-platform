          ...
          {#if progressValue}
            ...
            <div class="progress-row">
              ...
              <progress
                ...
                max={progressValue[0]}
              ></progress>
              <div class="progress-message">시작이 반입니다!</div>
            </div>
            {/if}
            ...
            <div class="progress-row">
              ...
              <progress
                ...
                max={progressValue[0]}
              ></progress>
              <div class="progress-message">벌써 절반이나 왔습니다!</div>
            </div>
            {/if}
            ...
            <div class="progress-row">
              ...
              <progress
                ...
                max={progressValue[0]}
              ></progress>
              <div class="progress-message">거의 다했습니다!</div>
            </div>
            {/if}
            ...
            <div class="progress-row">
              ...
              <progress
                ...
                max={progressValue[0]}
              ></progress>
              <div class="progress-message">축하합니다! 학습을 완료했습니다!</div>
            </div>
            {/if}
          {:else}
            <div>loading...</div>
